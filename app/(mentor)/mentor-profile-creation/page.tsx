    ...
    <div className={`flex ${styles.scroll}`}>
      ...
      <div className="flex flex-col w-[50%] relative max-h-[100vh]">
        ...
        <svg
          ...
          className="lg:w-[195px] md:w-[152px] min-h-[31px] w-[130px] mb-[80px] sticky top-0 mt-5 mx-10"
        >
          <path
        ...
        <div className="flex items-start relative gap-[100px] w-[100%] max-h-[100%] overflow-x-hidden">
          {/* form 1 */}
          <div className="form-container w-[100%] h-[100%] overflow-y-scroll absolute p-10 pt-0 ">
            <HeadingBuild
              currForm={currForm}
          ...
          {/* form 2 */}
          <div className="form-container w-[100%] h-[100%] pt-0 overflow-y-scroll opacity-0  absolute p-10">
            <HeadingBuild
              currForm={currForm}
