...
export { default as DashboardMenteeProfileImg } from "./assets/images/mentee-profile-screen/Ellipse 1 (1).png";
export { default as DashboardMenteeProfileVerifiedmark } from "./assets/Icons/verified (2) 1.png";
