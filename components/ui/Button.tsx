...
const getVariant = (variant: string) => {
  switch (variant) {
    ...
    case "disabled-primary":
      return "bg-[#CCCCCC] text-[#808080]  font-inetr  text-[16px]  rounded-[6px] sm:rounded-[8px]  font-[500]";

    case "disabled-secondary":
      return "bg-[#808080] text-[#808080]  font-inetr  text-[16px]  border-[1.5px] font-[500] rounded-[6px] sm:rounded-[8px] ";
